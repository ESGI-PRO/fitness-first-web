...
export default function Invoice() {
  ...
  return (
    <div>
      ...
      <div class="col-span-12 mx-4 mb-4 rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-6 md:mx-6 lg:my-6 xl:col-span-10 xl:col-start-2 xl:p-8 2xl:col-span-8 2xl:col-start-3">
        <div class="space-y-6 overflow-hidden p-4 md:p-8">
          <div class="sm:flex">
            <div class="mb-5 text-2xl font-bold dark:text-white sm:mb-0 sm:text-3xl">
              Facture {invoice?.subscriptionId}
            </div>
          ...
          <div class="sm:w-72">
            <div class="mb-4 text-base font-bold uppercase text-gray-900 dark:text-white">
              Facturé le {invoice?.createdAt}
            </div>
            <address class="text-base font-normal text-gray-500 dark:text-gray-400">
              Fitness First By ESGI , LOUISVILLE, Selby 3864 Johnson Street,
              United States of America VAT Code: AA-1234567890
            </address>
          </div>
            ...
            <div class="overflow-x-auto border-b border-gray-200 dark:border-gray-600">
              <div class="inline-block min-w-full align-middle">
                <div class="overflow-hidden shadow">
                  ...
                  >
                    <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400 min-w-full text-gray-900">
                      <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                          <th class="px-6 py-3">Item</th>
                          <th class="px-6 py-3">Price</th>
                          <th class="px-6 py-3">Qty</th>
                          <th class="px-6 py-3">Off</th>
                          <th class="px-6 py-3">Total</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr data-testid="table-row-element" class="">
                          <td class="px-6 py-4 whitespace-nowrap p-4 text-sm font-normal">
                          ...
                          <td class="px-6 py-4 whitespace-nowrap p-4 text-base font-normal text-gray-500 dark:text-gray-400">
                            $128.00
                          </td>
                          <td class="px-6 py-4 whitespace-nowrap p-4 text-base font-semibold text-gray-900 dark:text-white">
                            1
                          </td>
                          <td class="px-6 py-4 whitespace-nowrap p-4 text-base font-normal">
                            50%
                          </td>
                          <td class="px-6 py-4 whitespace-nowrap p-4 text-base font-semibold">
                            $64.00
                          </td>
                        </tr>
                      </tbody>
